        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              _connectionPill('Wi-Fi', connection.wifiName.isEmpty ? 'Not configured' : connection.wifiName),
              _connectionPill('Line', connection.onlineStatus.isEmpty ? 'unknown' : connection.onlineStatus),
            ],
          ),
        ],
      ),
