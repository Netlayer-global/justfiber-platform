...
function mapPlan(plan: any): Plan {
  ...
  return {
    ...
    merchandising: {
      ...
      bannerImageUrl: plan.merchandising?.bannerImageUrl || '',
      subtitle: plan.merchandising?.subtitle || '',
      badges: Array.isArray(plan.merchandising?.badges) ? plan.merchandising.badges : [],
      highlightFeatures: Array.isArray(plan.merchandising?.highlightFeatures) ? plan.merchandising.highlightFeatures : [],
    },
